...
<div class="content">
    ...
    <form action="processar_categorias_tags.php" method="POST">
            <div class="form-group">
                <label for="categoria">Nova Categoria:</label>
                <input type="text" id="categoria" name="categoria" class="form-control" required>
            </div>
            <button type="submit" class="btn btn-add">Adicionar Categoria</button>
        </form>
        ...
        <button class="btn btn-add" id="btn-add-tag">Adicionar Tag</button>
...
<script>
        ...
        function addTag() {
            ...
            if (tagName !== "") {
                ...
                var tagContainerDiv = document.getElementById("tag-container");
        ...
        // Evento de clique no botão Adicionar Tag
